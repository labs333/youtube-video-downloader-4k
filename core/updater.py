...
class UpdateChecker(QObject):
    ...
    def __init__(self):
        ...
        self.github_api_url = "https://api.github.com/repos/streamdownloader/YouTubeShortsDownloader/releases/latest"
        self.headers = {
            "User-Agent": f"YouTubeLabsShortsDownloader/{VERSION} ({platform.system()} {platform.release()})",
    ...
    def check_for_updates(self):
        ...
        try:
            response = requests.get(self.github_api_url, headers=self.headers, timeout=12)
