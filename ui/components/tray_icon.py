...
class TrayIconManager:
    ...
    def init_tray_icon(self):
        ...
        self.tray_icon.setToolTip(f"TubeTok Downloader {get_version(short=True)}")
        self.tray_icon.show()
    ...
    def show_running_message(self):
        self.tray_icon.showMessage(
            f"TubeTok Downloader {get_version(short=True)}",
    ...
    def show_error_message(self, text):
        self.tray_icon.showMessage(
            f"TubeTok Downloader {get_version(short=True)} - Error",
            text.split("\n")[0],
            QSystemTrayIcon.Critical,
            5000
        )
